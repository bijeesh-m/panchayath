...
const { fetchAllCertificate, certRequireMent } = require("../Controllers/certificateController");
...
router.get("/certificate/:certificateId/requirements",userAuth, certRequireMent)
