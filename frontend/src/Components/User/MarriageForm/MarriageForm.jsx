...
function MarriageForm() {
    ...
    const validationSchema = Yup.object({
        ...
        HusbandAddress: Yup.string()
            .min(3, "*Name must be at least 3 characters long")
            .required("* This field is required"),
        HusbandPreviousMaritalStatus: Yup.string().required("* This field is required"),
        ...
        WifeAddress: Yup.string()
            .min(3, "*Name must be at least 3 characters long")
            .required("* This field is required"),
        WifePreviousMaritalStatus: Yup.string().required("* This field is required"),
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="formbold-input-flex">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={formik.handleChange}
                                />
                                {formik.touched.PlaceOfMarriage && formik.errors.PlaceOfMarriage ? (
                                    <p
                                        className="text-danger"
                                        style={{
                                            fontSize: "12px",
                        ...
                        <div className="formbold-input-flex">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={formik.handleChange}
                                />
                                {formik.touched.HusbandDateOfBrith && formik.errors.HusbandDateOfBrith ? (
                                    <p
                                        className="text-danger"
                                        style={{
                                            fontSize: "12px",
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={formik.handleChange}
                            />
                            {formik.touched.HusbandNationality && formik.errors.HusbandNationality ? (
                                <p
                                    className="text-danger"
                                    style={{
                                        fontSize: "12px",
                        ...
                        <div className="formbold-mb-3">
                            <label htmlFor="HusbandPreviousMaritalStatus" className="formbold-form-label">
                        ...
                        <div className="formbold-input-flex">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={formik.handleChange}
                                />
                                {formik.touched.WifeDateOfBrith && formik.errors.WifeDateOfBrith ? (
                                    <p
                                        className="text-danger"
                                        style={{
                                            fontSize: "12px",
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={formik.handleChange}
                            />
                            {formik.touched.WifeNationality && formik.errors.WifeNationality ? (
                                <p
                                    className="text-danger"
                                    style={{
                                        fontSize: "12px",
                        ...
                        {/* wife Marital Status */}
                        <div className="formbold-mb-3">
                            <label htmlFor="WifePreviousMaritalStatus" className="formbold-form-label">
                                Previous Marital Status
                            </label>
                            <select
                            ...
                            {formik.touched.WifePreviousMaritalStatus && formik.errors.WifePreviousMaritalStatus ? (
                                <p
                                    className="text-danger"
                                    style={{
                                        fontSize: "12px",
                        ...
                        <div className="formbold-mb-3">
                            ...
                            <input
                                ...
                                onBlur={formik.handleBlur}
                                onChange={(event) => {
                                    formik.setFieldValue("WifeAadharImage", event.target.files[0]);
                                }}
                            />
                            {formik.touched.WifeAadharImage && formik.errors.WifeAadharImage ? (
                                <p
                                    className="text-danger"
                                    style={{
                                        fontSize: "12px",
